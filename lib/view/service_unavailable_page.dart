...
import '../bloc/init_bloc/bloc/init_bloc.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Message
              CustomText(text: 'Our servers are currently under maintenance or experiencing high traffic. Please try again later.',
              textAlign: TextAlign.center,
              ...
              TextButton.icon(
                ...
                label:CustomText(text: 'Contact Support',
                fontSize: 16,
